/* Complex routines Cvector, Cmatrix, C3tensor 
   free_Cvector, free_Cmatrix &free_C3tensor and 
   double routines d3tensor & free_d3tensor (ANSI)
   added July 16 1993 by Bjorn von Sydow */
...
double complex *Cvector(long nl, long nh)
...
double complex **Cmatrix(long nrl, long nrh, long ncl, long nch)
...
double complex ***C3tensor(long nrl, long nrh, long ncl, long nch, long ndl, long ndh)
/* allocate a double complex 3tensor with range t[nrl..nrh][ncl..nch][ndl..ndh] */
{
	long i,j,nrow=nrh-nrl+1,ncol=nch-ncl+1,ndep=ndh-ndl+1;
	double complex ***t;
...
void free_Cvector(double complex *v, long nl, long nh)
/* free a double complex vector allocated with Cvector() */
{
	free((FREE_ARG) (v+nl-NR_END));
}
...
void free_Cmatrix(double complex **m, long nrl, long nrh, long ncl, long nch)
/* free a double complex matrix allocated by Cmatrix() */
{
	free((FREE_ARG) (m[nrl]+ncl-NR_END));
	free((FREE_ARG) (m+nrl-NR_END));
}
...
void free_C3tensor(double complex ***t, long nrl, long nrh, long ncl, long nch,
	long ndl, long ndh)
/* free a double complex C3tensor allocated by C3tensor() */
{
	free((FREE_ARG) (t[nrl][ncl]+ndl-NR_END));
	free((FREE_ARG) (t[nrl]+ncl-NR_END));
	free((FREE_ARG) (t+nrl-NR_END));
