...
#ifndef _COMPLEX_MYOLD_H
#define _COMPLEX_MYOLD_H
...
#define _Imaginary_I (1.0fi)            /* (?) Does this work?? */
#define I _Imaginary_I

/* 
 * These are not typed in gcc.
 * They preseve the type of the argument. (?)
 */

/* 
 * TODO: CAPITALIZE these, to show that they are
 * part of the preprocessor
 */

#define conj(x) (~(x))                  /* Complex conjugate */
#define cimag(x) (__imag__ (x))         /* Get imaginary part */
#define creal(x) (__real__ (x))         /* Get real part */

extern double atan2(double, double);
#define carg(z) (atan2 ((double) cimag (z), (double) creal (z)))

#define complex __complex__             /* New C language keyword. */
...
/* 
 * The builtin complex absolute value in gcc currently
 * is unreachable due to overzealous type checking.
 */
 ...
 * This is how you declare complex
 * things in the new C language.
 */
